...
def show_notification(message):
    ...
    if not notification_displayed:
        ...
        messagebox.showinfo("CCTV1", message)
...
# Construct the absolute path to the YOLO model (best.pt)
...
#main(vid_path = 'rtsp://admin:kurtdecena1@192.168.1.9:554/mpeg4/ch1/main/av_stream', vid_out='live.avi')  ### for custom video
main(vid_path = 0, vid_out='live.avi')  ### for custom video