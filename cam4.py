...
def show_notification(message):
    ...
    if not notification_displayed:
        ...
        messagebox.showinfo("CCTV4", message)
...
def display_frames(vid_path, model, confidence_threshold,image_name="captured_image.jpg"):
    ...
    while cap.isOpened():
        ...
        cv2.imshow("cam4", frame_with_boxes)
...
main(vid_path='rtsp://admin:kurtdecena1@192.168.1.12:554/mpeg4/ch1/main/av_stream', vid_out='live.avi')  ### for custom video